...
import net.saltfactory.demo.gcm.R;
...
public class ListViewBtnAdapter extends ArrayAdapter implements View.OnClickListener {
    ...
    //생성자로부터 전달된 resource id 값 저장
    int resourceId;
    //생성자로부터 전달된 ListBtnClickListener 저장
    private ListBtnClickListener listBtnClickListener;
    //생성, 마지막에 LitBtnClickListener 지정
    ...
    //새로만드는 Layout을 위한 View를 생성하는 코드
    @Override
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        /*button1.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                textTextView.setText(Integer.toString(pos + 1) + "번 아이템 선");
            }
        });*/
    ...
    // ToggleButton이 눌려졌을 때 실행되는 onClick함수.
    public void onClick(View v) {
